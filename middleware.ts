...
const protectedPaths = ['/dashboard', '/create', '/ideas', '/drafts', '/calendar', '/analytics', '/settings']
...
export const config = {
  matcher: ['/', '/login', '/register', '/dashboard/:path*', '/create/:path*', '/ideas/:path*', '/drafts/:path*', '/calendar/:path*', '/analytics/:path*', '/settings/:path*'],
}
